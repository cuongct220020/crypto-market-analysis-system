...
2. Create cronjobs: 
```bash
0 0 * * * /home/airflow-cluster/airflow-cluster/scripts/airflow_clean_dag_logs.sh
0 10 * * * /home/airflow-cluster/airflow-cluster/scripts/airflow_clean_scheduler_logs.sh
```