...
class KafkaSettings(BaseModel):
    ...
    producer_queue_buffering_max_messages: int = Field(default=100000, gt=0, validation_alias="KAFKA_PRODUCER_QUEUE_BUFFERING_MAX_MESSAGES")
    producer_flush_timeout_seconds: int = Field(default=10, gt=0, validation_alias="KAFKA_PRODUCER_FLUSH_TIMEOUT_SECONDS")
    
    # Schema Registry
    schema_registry_url: str = Field(default="http://localhost:8081", validation_alias="SCHEMA_REGISTRY_URL", description="URL of the Schema Registry")
